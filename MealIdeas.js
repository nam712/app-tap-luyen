  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.popularSection}>
        <TouchableOpacity style={styles.infoContainer} onPress={() => navigation.navigate('RecipeVideo', { item:mealideaData[activeTab][0] })} >
      ...
      <Text style={styles.sectionTitle}>Recommended </Text>
        ...
        <View style={styles.itemList}>
          {mealideaData[activeTab].slice(3).map((item, index) => (
            <TouchableOpacity key={index} style={styles.itemCard} onPress={() => navigation.navigate('RecipeVideo', { item })}>
